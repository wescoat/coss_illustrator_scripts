...
below. The defaults provide a background based on SJSU's preferred gold color;
for convenience, an alternative function is provided that will produce a
background based on SJSU's preferred shade of blue:
...
(function (my) {
	...
	var defaults = {
			...
			red: 199,        // RGB      (used for background)
			green: 153,      //   for
			blue: 0,         //   gold
